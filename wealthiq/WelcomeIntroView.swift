  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 24) {
      ...
      VStack(alignment: .leading, spacing: 14) {
        ...
        Text(
          "There is no silver bullet to success. In all cases it requires sacrifice, discipline, and self-discovery. WealthIQ will give you the most modern, clinically backed tools to help you break down the barriers between you and the life of your dreams."
        )
        Text(
