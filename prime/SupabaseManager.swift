...
class SupabaseManager: ObservableObject {
  ...
  func saveOnboardingData(
    ...
    do {
      print("📤 Sending profile to Supabase...")
      ...
      print("✅ Supabase response received - profile saved/updated")
      return response.value
    } catch {
      print("❌ Supabase error during profile save:")
      print("  - Error: \(error)")
  ...
  func signOut() async throws {
    do {
      ...
      print("⚠️ Sign out error (will clear session anyway): \(error)")
  ...
  func forceClearSession() {
    ...
    print("🔄 Force cleared local session")
  }
  ...
  func getCurrentUserId() async throws -> UUID {
    do {
      ...
      guard let userId = UUID(uuidString: session.user.id.uuidString) else {
        print("❌ Could not parse user ID: \(session.user.id.uuidString)")
        throw SupabaseError.authenticationRequired
      }
      return userId
    } catch {
  ...
  func testConnection() async {
    print("🧪 [SupabaseManager] Testing connection...")
    ...
    do {
      ...
      print("✅ [SupabaseManager] Connection test successful")
    } catch {
      print("❌ [SupabaseManager] Connection test failed:")
      print("   - Error: \(error)")
